...
public class DemoController {
   ...
   */
  @GetMapping("/info")
  public ResponseEntity<InfoGetResponse> getInfo(
      @Validated @RequestBody InfoGetRequest infoGetRequest) {
   ...
   */
  @PutMapping("/info")
  public ResponseEntity<InfoCreateResponse> createInfo(InfoCreateRequest infoCreateRequest) {
   ...
   */
  @PostMapping("/info")
  public ResponseEntity<InfoUpdateResponse> updateInfo(InfoUpdateRequest infoUpdateRequest) {
   ...
   */
  @DeleteMapping("/info")
  public ResponseEntity<InfoDeleteResponse> deleteInfo(InfoDeleteRequest infoDeleteRequest) {
